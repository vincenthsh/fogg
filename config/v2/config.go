...
type Component struct {
	...
	CdktfScripts         map[string]string      `yaml:"cdktf_scripts,omitempty"`          // Optional additional component package.json scripts, built-in script names can not be overridden, default: {}
